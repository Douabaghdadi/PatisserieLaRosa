        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <nav aria-label="breadcrumb" style={{ marginBottom: '12px' }}>
            <ol className="breadcrumb" style={{ backgroundColor: 'transparent', padding: 0, margin: 0, display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <li className="breadcrumb-item active" style={{ color: 'white', fontSize: '13px', fontWeight: '600' }}>{category?.name}</li>
            </ol>
          </nav>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '15px' }}>
            <div style={{ width: '50px', height: '50px', background: 'rgba(255,255,255,0.2)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <i className="fas fa-birthday-cake" style={{ color: 'white', fontSize: '22px' }}></i>
            </div>
            <div>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            <span style={{
              ...
              <i className="fas fa-box" style={{ fontSize: '11px' }}></i>
        ...
        <div className="d-lg-none" style={{ marginBottom: '20px' }}>
          ...
          >
            <span style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              Filtres et tri
              {(selectedBrand || selectedSubcategory || selectedFlavor || showDiscountOnly || priceRange.min || priceRange.max) && (
            ...
            <div style={{
              ...
              {subcategories.length > 0 && (
                <div style={{ marginBottom: '25px' }}>
                  <label style={{ fontSize: '13px', fontWeight: '600', color: '#ec4899', marginBottom: '10px', display: 'block', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Sous-catégorie</label>
                  <select 
                    style={{ 
                      width: '100%', 
                      padding: '12px 15px', 
                  ...
                  >
                    <option value="" style={{ padding: '10px', color: '#64748b' }}>Toutes les sous-catégories</option>
                    {subcategories.map((sub: any) => (
                      <option key={sub._id} value={sub._id} style={{ padding: '10px', color: '#1a202c' }}>{sub.name}</option>
                    ))}
                  </select>
                </div>
              )}
              ...
              <div style={{ marginBottom: '25px' }}>
                <label style={{ fontSize: '13px', fontWeight: '600', color: '#ec4899', marginBottom: '10px', display: 'block', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Goût</label>
                <FlavorDropdown 
                  flavors={flavors}
                  selectedFlavor={selectedFlavor}
                  onSelect={setSelectedFlavor}
              ...
              <div style={{ marginBottom: '25px' }}>
                <label style={{ fontSize: '13px', fontWeight: '600', color: '#ec4899', marginBottom: '10px', display: 'block', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Prix (DT)</label>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                  <input 
                    ...
                    style={{ width: '100%', padding: '12px', border: '2px solid #fce7f3', borderRadius: '12px', fontSize: '14px', outline: 'none' }}
                  />
                  <input 
                    type="number" 
                    placeholder="Max" 
              ...
              <div style={{ marginBottom: '25px' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer', padding: '12px', background: showDiscountOnly ? '#fce7f3' : '#f8f9fa', borderRadius: '12px', transition: 'all 0.3s' }}>
                  <input 
                    type="checkbox" 
                  ...
                  />
                  <span style={{ fontSize: '14px', color: showDiscountOnly ? '#ec4899' : '#64748b', fontWeight: '600' }}>
              ...
              <div style={{ marginBottom: '25px' }}>
                <label style={{ fontSize: '13px', fontWeight: '600', color: '#ec4899', marginBottom: '10px', display: 'block', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Trier par</label>
                <select 
                  style={{ 
                    width: '100%', 
                    padding: '12px 15px', 
                  ...
                  onBlur={(e) => e.target.style.borderColor = '#fce7f3'}
                >
                  <option value="" style={{ padding: '10px', color: '#64748b' }}>Par défaut</option>
                  <option value="price-asc" style={{ padding: '10px', color: '#1a202c' }}>Prix croissant</option>
                  <option value="price-desc" style={{ padding: '10px', color: '#1a202c' }}>Prix décroissant</option>
                </select>
              </div>
                      ...
                      <div style={{
                        ...
                        <div style={{ padding: '20px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'baseline', gap: '10px', marginBottom: '16px', marginTop: 'auto' }}>
                            ...
                            <span style={{ fontSize: '20px', fontWeight: '800', color: (product.discount ?? 0) > 0 ? '#16a34a' : '#ec4899' }}>{finalPrice.toFixed(3)}</span>
