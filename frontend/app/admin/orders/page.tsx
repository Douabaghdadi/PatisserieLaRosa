...
function OrdersContent() {
  ...
  const getStatusBadge = (status: string, large = false) => {
    const badges: any = {
      ...
      cancelled: { bg: "linear-gradient(135deg, #d946a6 0%, #dc2626 100%)", icon: "mdi-close-circle-outline", text: "Annulée" }
    };
      ...
      days.push(
        <div
          ...
          style={{
            ...
            backgroundColor: isSelected ? '#d946a6' : ordersCount > 0 ? '#fef2f2' : 'transparent',
            color: isSelected ? 'white' : 'inherit',
            border: isTodayDate ? '2px solid #d946a6' : '1px solid transparent',
        ...
        >
          ...
          {ordersCount > 0 && (
            <span style={{
              fontSize: '10px',
              backgroundColor: isSelected ? 'white' : '#d946a6',
              color: isSelected ? '#d946a6' : 'white',
      ...
      <div className="card mb-4">
        <div className="card-body">
          <div className="d-flex justify-content-between align-items-center mb-3">
            <button className="btn btn-sm" style={{ background: "#fef2f2", color: "#d946a6", border: "1px solid #fecaca" }} onClick={prevMonth}>
              <i className="mdi mdi-chevron-left"></i>
            </button>
            <h5 className="mb-0" style={{ color: "#d946a6" }}>
              <i className="mdi mdi-calendar"></i> {monthNames[currentMonth.getMonth()]} {currentMonth.getFullYear()}
            </h5>
            <button className="btn btn-sm" style={{ background: "#fef2f2", color: "#d946a6", border: "1px solid #fecaca" }} onClick={nextMonth}>
          ...
          {selectedDate && (
            <div className="mt-3 pt-3 border-top">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <button className="btn btn-sm" style={{ background: "#fef2f2", color: "#d946a6", border: "1px solid #fecaca" }} onClick={() => setSelectedDate(null)}>
          ...
          <div className="content-wrapper">
            ...
            <div className="row mb-4">
              <div className="col-md-3 stretch-card grid-margin">
                <div className="card" style={{ background: "linear-gradient(135deg, #d946a6 0%, #be185d 100%)", color: "white" }}>
                  <div className="card-body">
                  ...
                  <div className="card-body">
                    ...
                    <div className="mb-4">
                      <div className="row g-2 mb-3 align-items-center">
                        ...
                        <div className="col-lg-3 col-md-6">
                          <button className={`btn w-100`} style={{ background: showFilters ? "linear-gradient(135deg, #d946a6 0%, #be185d 100%)" : "#fef3f2", color: showFilters ? "white" : "#d946a6", border: showFilters ? "none" : "1px solid #fce7f3" }} onClick={() => setShowFilters(!showFilters)}>
                      ...
                      {showFilters && (
                        <div className="card shadow-sm border-0 mt-3" style={{ backgroundColor: '#f8f9fa' }}>
                          <div className="card-body">
                            <h6 className="mb-3" style={{ color: "#d946a6" }}><i className="mdi mdi-filter-variant"></i> Filtres avancés</h6>
                            ...
                            <div className="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                              ...
                              <span style={{ background: "linear-gradient(135deg, #d946a6 0%, #be185d 100%)", color: "white", padding: "6px 16px", borderRadius: "50px", fontSize: "0.85rem", fontWeight: 600 }}>{filtered.length} résultat{filtered.length > 1 ? 's' : ''}</span>
                            </div>
                          </div>
                        </div>
                      )}
                      ...
                      <table className="table table-hover">
                        ...
                        <tbody>
                          {filtered.length > 0 ? filtered.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map((order: any) => (
                            <tr key={order._id}>
                              <td><span style={{ fontWeight: 700, color: "#d946a6" }}>#{order._id.slice(-8).toUpperCase()}</span></td>
                              <td>
                              ...
                              <td>
                                <button onClick={() => viewOrderDetails(order)} style={{ background: "linear-gradient(135deg, #d946a6 0%, #be185d 100%)", color: "white", border: "none", padding: "8px 14px", borderRadius: "8px", cursor: "pointer" }} title="Voir détails">
      ...
      {showModal && selectedOrder && (
        <>
          <style>{`
            ...
            .info-section-title i { color: #d946a6; font-size: 1rem; }
            ...
            .status-card:hover { border-color: #d946a6; transform: translateY(-2px); }
            .status-card-label {
              font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.1em;
            ...
            .total-value { font-size: 1.5rem; font-weight: 800; color: #d946a6; }
            ...
            .btn-cancel { background: linear-gradient(135deg, #d946a6 0%, #dc2626 100%); color: white; }
              ...
              <div className="order-modal-body">
                ...
                <div style={{ marginTop: "20px" }}>
                  <button 
                          ...
                          <head>
                            ...
                            <style>
                              * { margin: 0; padding: 0; box-sizing: border-box; }
                              ...
                              .header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 40px; padding-bottom: 20px; border-bottom: 3px solid #d946a6; }
                              .logo { font-size: 28px; font-weight: bold; color: #d946a6; }
                              .logo-sub { font-size: 12px; color: #666; }
                              .doc-info { text-align: right; }
                              .doc-title { font-size: 24px; font-weight: bold; color: #1e293b; margin-bottom: 8px; }
                              .doc-number { font-size: 14px; color: #d946a6; font-weight: 600; }
                              ...
                              .info-box { background: #f8fafc; padding: 20px; border-radius: 8px; border-left: 4px solid #d946a6; }
                              ...
                              .total-value { font-size: 28px; font-weight: bold; color: #d946a6; }
                              ...
                              .company-footer { margin-top: 40px; padding: 20px; background: #d946a6; color: white; text-align: center; border-radius: 8px; }
                    ...
                    onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#d946a6"; e.currentTarget.style.color = "#d946a6"; e.currentTarget.style.background = "#fef2f2"; }}
