...
export default function EditCategoryPage() {
  ...
  const displayImage = imagePreview || (currentImage ? `${API_URL.replace(/\/api$/, "")}${currentImage}` : null);
        ...
        <div className="main-panel">
          <div className="content-wrapper">
            <div className="page-header">
              <h3 className="page-title">Modifier la catégorie</h3>
                        ...
                        <div className="d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <label htmlFor="categoryImage" className="btn btn-outline-primary btn-sm">
                              <i className="mdi mdi-upload"></i> {currentImage ? 'Changer l\'image' : 'Choisir une image'}
                            </label>
