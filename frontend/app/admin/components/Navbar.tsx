    ...
    <>
      ...
      <nav style={{
        ...
        <Link href="/admin" style={{ display: "flex", alignItems: "center", gap: "0.75rem", textDecoration: "none", width: "260px", paddingRight: "1rem" }}>
          <img src="/img/logo-la-rosa.png" alt="La Rosa" style={{ height: "40px", width: "auto", maxWidth: "180px", objectFit: "contain" }} />
        </Link>
            ...
            <form onSubmit={handleSearch} style={{ position: "relative", width: "400px" }}>
              ...
              <input 
                ...
                style={{
                  ...
                  border: "2px solid #fce7f3", borderRadius: "10px",
                  fontSize: "0.875rem", background: "#fef3f2", outline: "none"
                }}
              />
            </form>
          </div>
            ...
            <div className="profile-dropdown-container" style={{ position: "relative" }}>
              <button 
                ...
                style={{
                  ...
                  border: "2px solid #fce7f3", borderRadius: "50px",
              ...
              {showDropdown && (
                <div style={{
                  ...
                  <Link 
                    ...
                    onMouseEnter={(e) => { e.currentTarget.style.background = "#fef3f2"; e.currentTarget.style.color = "#d946a6"; }}
                    onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "#475569"; }}
                  >
                    <i className="mdi mdi-account-outline" style={{ fontSize: "1.125rem", width: "24px" }}></i>
                    Mon profil
                  </Link>
                  <div style={{ height: "1px", background: "#fce7f3", margin: "0.5rem 0" }}></div>
                  <button 
                    ...
                    onMouseEnter={(e) => { e.currentTarget.style.background = "#fef2f2"; e.currentTarget.style.color = "#d946a6"; }}
                    onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "#475569"; }}
                  >
