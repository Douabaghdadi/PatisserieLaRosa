...
export default function PromoSection() {
  ...
  const [macaronsSubcategoryId, setMacaronsSubcategoryId] = useState<string | null>(null);
    ...
    fetch(`${API_URL}/subcategories')
      ...
      .then(subcategories => {
        const macaronsSubcategory = subcategories.find((sub: any) => 
          sub.name === 'Macarons classiques' || sub.name.toLowerCase().includes('macaron')
        );
        if (macaronsSubcategory) {
          setMacaronsSubcategoryId(macaronsSubcategory._id);
          console.log('Sous-catégorie Macarons trouvée:', macaronsSubcategory);
        }
      })
      ...
      <div className="container">
        <div className="row g-4">
          ...
          <div className="col-lg-3 d-none d-lg-block">
            <Link 
              href={macaronsSubcategoryId ? `/subcategory/${macaronsSubcategoryId}` : '/shop'}
              style={{
                display: 'block',
                borderRadius: '20px',
                height: '100%',
              ...
              <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 2 }}>
                  ...
                  <p style={{ 
                    ...
                    Découvrez nos délicieux macarons
                  </p>
                  <span style={{
                    display: 'inline-flex',
                    alignItems: 'center',
