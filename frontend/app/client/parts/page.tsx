      ...
      <div className="container">
          ...
          <div>
            ...
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb mb-0">
                ...
                <li className="breadcrumb-item active">Pièces détachées</li>
              </ol>
            </nav>
          </div>
        ...
        <div className="card border-0 shadow-sm">
          <div className="card-body text-center py-5">
            ...
            <h4 className="mt-3 mb-2">ROLLANDPARTS</h4>
            <p className="text-muted">Commandez les pièces détachées de vos équipements en ligne</p>
